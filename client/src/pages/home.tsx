...
import SpecialtiesSection from "@/components/SpecialtiesSection"; // Especialidades oferecidas
...
export default function Home() {
  ...
  const sections = [
    ...
    },
    {
      ...
      visible: true, // Assuming SpecialtiesSection should always be visible or controlled differently
      order: orderConfig.specialties ?? 2
    },
    {
      key: 'services',
      component: <ServicesSection />,
      visible: isServicesVisible, 
      order: orderConfig.services ?? 3
    },
    {
      key: 'testimonials',
      component: <TestimonialsCarousel />,
      visible: isTestimonialsVisible,
      order: orderConfig.testimonials ?? 4
    },
    {
      key: 'faq',
      component: <FAQSection />,
      visible: isFaqVisible,
      order: orderConfig.faq ?? 5
    },
    {
      key: 'contact',
      component: <ContactSection />,
      visible: isContactVisible,
      order: orderConfig.contact ?? 6
    },
    {
      key: 'photo-carousel',
    ...
    },
    {
      ...
      order: orderConfig.inspirational ?? 7
    }
